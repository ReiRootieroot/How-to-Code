...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |P7 rocket-error-starter|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;(require spd/tags)
;
;(@assignment htdd-p7)
;(@csid ??? ???)
