...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |P14 overlay-starter|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
;; overlay-starter.rkt
