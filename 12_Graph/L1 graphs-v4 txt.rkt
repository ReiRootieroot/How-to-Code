...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname |L1 graphs-v4 txt|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
;; Room String -> Boolean
;; show whether possible to reach room with given name starting at given room
